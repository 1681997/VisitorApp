...
<body>
	...
	<form action="searchbydate.jsp" method="post">
		<input type="date" date-format="yyyy-MM-dd" placeholder="Select Date"
			name="serachbydate">
		<button type="submit">Search</button>
	</form>

	<%
	String date = request.getParameter("serachbydate");
	Connection con = visiterconnection.getConnection();
	PreparedStatement pst = con.prepareStatement("select * from register where date='" + date + "'");
